...
import group5 from "../../src/imgs/group5.png";
import image9 from "../../src/imgs/img9.png";

const LearnMore = () => {
  return (
    <section className="learn-more h-[850px] md:h-[600px] xl:h-[774px] mt-10 pt-8 md:py-24 md:px-8 lg:p-24 relative">
      <div className="lg:max-w-7xl mx-auto md:flex md:items-center px-8 md:px-0 ">
        <div className="w-full md:w-[50%]">
          <div className=" w-full md:w-[415px] mt-[30px]">
            <h1 className=" text-[40px] md:text-[48px] font-[700] text-white">
              Metabnb NFTs
            </h1>
            <p className="text-[18px] font-[400] text-white mt-10 mb-4 md:mb-14 leading-9">
            ...
            <Link to="/register">
              <div className="bg-white w-full md:w-[156px] flex justify-center items-center h-[48px] text-[ #A02279] rounded-[10px] baseline text-[#A02279] hover:text-white hover:bg-[#532545] transition">
                <p> Learn More</p>
              </div>
            </Link>
          </div>
        ...
        <div className="pl-[40px] xl:w-[704px]">
          <div className="lg:flex">
            ...
            <div className="absolute right-[2%] md:right-[5%] md:top-[56%]  lg:top-[48%] lg:right-[4%] xl:right-[10%] xl:top-[45%] z-30 md:w-[200px] lg:w-[300px] xl:w-[378.2px] xl:h-[253.89px]">
              <img src={image8} alt="" className="hidden md:flex cover" />
            </div>
